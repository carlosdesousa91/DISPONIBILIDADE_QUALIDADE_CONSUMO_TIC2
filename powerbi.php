...
function embeddedToken($access_token_decoded, $report_id){
    $base_url = 'https://api.powerbi.com/v1.0/myorg/groups/63df1a7f-98af-4f6d-9639-a1f3d011e5e2/reports/' . $report_id . '/GenerateToken';
